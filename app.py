...
# --- CSS CUSTOM (GIAO DIỆN KHỐI CARD SỐNG ĐỘNG) ---
st.markdown("""
    <style>
    .stApp { background-color: #0e1117; color: #ffffff; }
    [data-testid="stSidebar"] { background-color: #161b22; }

    /* Thiết kế từng khối Card */
    .vocab-card {
        background: #1c2128;
...
if menu == "⚙️ Dashboard Quản lý":
    ...
    if not df_current.empty:
        ...
        st.info("Danh sách trống. Hãy thêm từ vựng để bắt đầu học!")
...
# --- 2. FLASHCARD ---
    ...
    if not df_current.empty:
        ...
        st.warning("Hãy thêm từ vựng trước.")
        ...
        if mode == "Dạng 1 (Nộp bài tập trung)":
            ...
            with st.form("exam_form"):
                ...
                if st.form_submit_button("📤 NỘP BÀI"):
                    score = sum(1 for i, it in enumerate(st.session_state.ex_list) if st.session_state.ans.get(i) == it['ans'])
